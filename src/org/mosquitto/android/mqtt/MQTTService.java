...
/*
 * This is Android MQTT code taken directly from http://dalelane.co.uk/blog/?p=1599
 * It was written by Dale Lane as described below. The only changes are to
 * replace all of the com.dalelane type package paths with org.mosquitto paths.
 */
...
public class MQTTService extends Service implements MqttSimpleCallback
{
	...
	synchronized void handleStart(Intent intent, int startId)
	{
		...
		if (isAlreadyConnected() == false)
		{
			...
			Intent notificationIntent = new Intent(this, MQTTDemo.class);
